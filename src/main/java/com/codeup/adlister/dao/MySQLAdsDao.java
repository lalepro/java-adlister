...
//        String selectQuery = createInsertQuery()
        try {
            PreparedStatement ps = connection.prepareStatement(createInsertQuery(ad));
            ps.executeUpdate(createInsertQuery(ad), Statement.RETURN_GENERATED_KEYS);
